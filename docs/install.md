...
1) Передите на страницу решения в маркетплейс 1с-Битрикс [ссылка](https://marketplace.1c-bitrix.ru/solutions/awz.currency/)
...
2) Введите код модуля awz.currency
...
1) Скачайте необходимую версию модуля с github, например, со страницы [releases](https://github.com/zahalski/awz.currency/releases)
2) Распакуйте архив
3) Загрузите модуль
   
**Если установка в UTF-8 версии**

Скопируйте папку с распакованного архива bitrix\modules\awz.currency в папку \bitrix\modules\ вашего сайта
...
- Переименовываем папку из .last_version в awz.currency
- Копируем нашу папку dist\awz.currency в папку \bitrix\modules\ вашего сайта
4) Проверяем или все верно
- Вместо awz.module на изображении Ваша папка будет с названием `awz.currency`
...
6) Выбираем модуль с кодом awz.currency и нажимаем установить
